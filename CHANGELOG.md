...
- The water sloshes when you drag the window: it leans against the motion, rings down, and fish feel the current.
- Optional desktop refraction (Settings, Windows and macOS): with a see-through tank and no decal, the app captures the screen behind the glass a few times a second and the water bends it. macOS asks for Screen Recording; Linux reports it unsupported.
